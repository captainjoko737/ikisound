...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{ url('assets/bower_components/bootstrap/dist/css/bootstrap-template.min.css') }}">
  <!-- Font Awesome -->
  ...
  <link rel="stylesheet" href="{{ url('assets/bower_components/jquery-ui/jquery-ui.css') }}">
