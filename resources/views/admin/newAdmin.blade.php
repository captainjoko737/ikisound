      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(array('route' => 'postNewAdmin','files'=>true)) !!}
            ...
            @if (count($errors) > 0)
             ...
             @elseif($success == 1) 
                <div class="alert btn-success">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <p>Create new Admin Successfuly</p>
                </div>
              @endif
            <div class="box-body">  
              ...
              <div class="row">
                ...
                <div class="col-xs-4">
                  <button type="submit" class="btn btn-primary btn-block btn-flat">Create Admin</button>
                </div>
                <div class="col-xs-4">
                 
                </div>
                <div class="col-xs-4">
                  <a href="{{ url('admin/allAdmin') }}" class="btn btn-primary btn-block btn-flat">Back</a>
                </div>
